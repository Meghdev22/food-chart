const foodOriginalData = [
  ...
  console.log("All Vegetables Data: ");
  getAllVegetablesData();
  ...
  console.log("All Dairy Data: ");
  getAllDairyData();

  function getMoreCalData(){
    for(let index = 0; index < foodOriginalData.length; index++){
  ...
  console.log("Above 100 Calorie: ");
  getMoreCalData();

  function getLessCalData(){
    for(let index = 0; index < foodOriginalData.length; index++){
      const calorie = foodOriginalData[index].calorie;
      if(calorie < 100){
        console.log(foodOriginalData[index]);
  ...
  console.log("Less than 100 Calorie: ")
  getLessCalData();

function protienHighToLow(){
  for(let index = 0; index < foodOriginalData.length; index++){
   const list =  foodOriginalData[index];
  }
}
console.log("All food data with high to low proteins: ");
protienHighToLow();